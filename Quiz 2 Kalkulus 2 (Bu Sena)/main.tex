...
\begin{enumerate}
    \item \begin{enumerate}
        ...
        \end{align*}
        \item The centroid of the surface area obtained by revolving the first-quadrant arc about the $y$-axis can be found using Pappus together with the surface-centroid formula. Parametrize the quarter-circle by
        \[ x=2\cos\theta,\qquad y=2\sin\theta,\qquad 0\leq\theta\leq\tfrac{\pi}{2},\]
        ...
        \[ S=L\cdot(2\pi\bar{x}_{\text{arc}})=\pi\cdot2\pi\cdot\frac{4}{\pi}=8\pi.\]
        ...
        Hence
        \[ \bar{x}_{\text{surf}}=\frac{2\pi\cdot2\pi}{8\pi}=\frac{\pi}{2}.\]

        Therefore the centroid of the resulting surface is located on the $x$-axis at a distance $\displaystyle\bar{x}_{\text{surf}}=\frac{\pi}{2}$ from the $y$-axis, i.e. at $\left(\dfrac{\pi}{2},0\right)$.
    \end{enumerate}
