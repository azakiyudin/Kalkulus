...
\begin{align*}
    ...
    \end{jawab}
        ...
        \begin{jawab}[grafik fungsi, Integral, Luas daerah]{
    \begin{center}
        \begin{tikzpicture}
...
\end{center}
        ...
        \begin{jawab}
            [deret, uji rasio]{\\
                Untuk mendapatkan lima suku pertama dari deret tersebut, kita substitusi nilai $n$ dari 1 hingga 5:
                \begin{align*}
                    a_1 &= \frac{1!}{5+1} = \frac{1}{6} \\
                    a_2 &= \frac{2!}{5+2} = \frac{2}{7} \\
                    a_3 &= \frac{3!}{5+3} = \frac{6}{8} = \frac{3}{4} \\
                    a_4 &= \frac{4!}{5+4} = \frac{24}{9} = \frac{8}{3} \\
                    a_5 &= \frac{5!}{5+5} = \frac{120}{10} = 12
                \end{align*}
                Jadi, lima suku pertama dari deret tersebut adalah $\frac{1}{6}, \frac{2}{7}, \frac{3}{4}, \frac{8}{3}, 12$.
