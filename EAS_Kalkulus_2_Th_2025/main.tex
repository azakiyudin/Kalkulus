...
\newpage
        \begin{enumerate}
            ...
            \begin{jawab}
                [titik berat, integral tentu, grafik fungsi]{\\
...
\end{tikzpicture}
    \end{center}
Diperhatikan bahwa daerah tersebut simetri terhadap garis vertikal $x=1$, sehingga $\overline{x}=1$. Selanjutnya, kita dapat menghitung $\overline{y}$ menggunakan rumus berikut:
\begin{align*}
...
&= \frac{\cfrac{1}{2}\displaystyle\int_{0}^{2} 1-(x-1)^2 dx}{\displaystyle\int_{0}^{2} \sqrt{1-(x-1)^2} dx}
\end{align*}
...
\begin{align*}
\overline{y} &= \frac{\frac{1}{2}\cdot\frac{4}{3}}{\frac{\pi}{2}} \\
&= \frac{\frac{2}{3}}{\frac{\pi}{2}} \\
&= \frac{4}{3\pi}
\end{align*}
Jadi, titik berat dari dataran tersebut adalah $\left(1, \frac{4}{3\pi}\right)$.
                }
            \end{jawab}
            ...
            \end{enumerate}
            \begin{jawab}
                [grafik fungsi, volume benda putar, metode cakram]{\\
...
\end{tikzpicture}
    ...
    Diperhatikan bahwa jari-jari $r$ adalah jarak dari sumbu putar ke partisinya, yaitu $r = x$, dan tinggi $h$ adalah jarak antara kedua garis tersebut, yaitu $h = \qty(2-\frac{2}{3}x) - \qty(-2+\frac{2}{3}x) = 4 - \frac{4}{3}x$. Kemudian, kita dapat menghitung volume benda padat yang diperoleh dari perputaran daerah tersebut menggunakan metode cakram sebagai berikut:
\allowdisplaybreaks
\begin{align*}
...
\end{align*}
        ...
        \\
        \begin{jawab}
            [grafik fungsi polar, integral fungsi trigonometri, luas daerah di dalam kurva polar]{
             \\
             Untuk menggambar kurvanya, kita perlu mencari titik potong antara kurva $r=6$ dan $r=4+4\cos\theta$ dengan menyamakan kedua persamaan tersebut:
\begin{align*}
6 = 4 + 4\cos\theta \qquad \Longleftrightarrow \qquad 4\cos\theta = 2 \qquad \Longleftrightarrow \qquad \cos\theta = \frac{1}{2}
...
\theta = \pm \frac{\pi}{3} + 2k\pi, \quad k \in \mathbb{Z}
\end{align*}
Jadi, titik potong antara kedua kurva tersebut terjadi pada $\theta = \frac{\pi}{3}$ dan $\theta = -\frac{\pi}{3}$. Berikut ini adalah sketsa dari kedua kurva tersebut, yaitu lingkaran $r=6$ dan kardioda $r=4+4\cos\theta$, serta daerah yang diarsir yang merupakan daerah di luar lingkaran $r=6$ dan di dalam kardioda $r=4+4\cos\theta$.
    \begin{center}
        \begin{tikzpicture}
\pgfplotsset{set layers}
  \begin{polaraxis}[xticklabel={$ \pgfmathprintnumber{\tick}^{\circ} $}]
    \addplot[domain=0:360,samples=300, color=red] {6};
    \addplot[domain=0:60,opacity=0, save path=\A] {6} -- (axis cs:60,0)
-- (axis cs:0,0)
-- cycle;
    \addplot[domain=60:300,opacity=0, save path=\B] {4+4*cos(x)} -- (axis cs:300,0)
-- (axis cs:0,0)
-- cycle;
    \pgfonlayer{axis background}
    \fill[gray!20, even odd rule, reuse path=\A];
    \fill[gray!20, reuse path=\B];
    \endpgfonlayer
    \addplot[domain=0:360,samples=300, color=blue] {4+4*cos(x)};
  \end{polaraxis}
    ...
    \end{center}
    Diperhatikan bahwa daerah tersebut simetri terhadap sumbu-$x$, sehingga kita dapat menghitung luas daerah tersebut dengan menghitung luas daerah di atas sumbu-$x$ dan kemudian mengalikannya dengan 2. \\
Diperhatikan pula bahwa daerah di atas sumbu-$x$ berada di antara kurva $r=6$ dan kurva $r=4+4\cos\theta$ untuk $\theta$ dari $\frac{\pi}{3}$ hingga $\pi$. Luas daerah tersebut adalah luas daerah dari $r=4+4\cos\theta$ dikurangi luas daerah dari $r=6$ dalam interval yang sama. Berikut adalah visualisasi dari daerah yang akan dihitung luasnya:
...
&= 4\pi + 9\sqrt{3}
\end{align*}
Dengan demikian, luas daerah di luar lingkaran $r=6$ dan di dalam kardioda $r=4+4\cos\theta$ adalah $L=2(L_2-L1) = 2((4\pi + 9\sqrt{3}) - 6\pi) = 18\sqrt{3}-4\pi$.
            }
            \end{jawab}
            \item[4.] Tentukan lima suku pertama barisan yang diberikan di bawah ini. Tentukan pula apakah barisan ini konvergen atau divergen. Jika konvergen dapatkan nilai kekonvergenannya
            \begin{align*}
                \left\{\frac{n}{3n+1}\right\}^{+\infty}_{n=1}
            \end{align*}
            \begin{jawab}
                [barisan, limit, konvergensi]{\\
                    Untuk mendapatkan lima suku pertama dari barisan tersebut, kita dapat menghitung nilai dari $a_n=\frac{n}{3n+1}$ untuk $n=1,2,3,4,5$ sebagai berikut:
                    \begin{align*}
                    ...
                    \end{align*}
                    Jadi, lima suku pertama dari barisan tersebut adalah $\frac{1}{4}, \frac{2}{7}, \frac{3}{10}, \frac{4}{13}, \frac{5}{16}$.
                    ...
                    \end{align*}
                    Kita dapat membagi pembilang dan penyebut dengan $n$ untuk mendapatkan bentuk yang lebih sederhana:
                    \begin{align*}
                    ...
                    \end{align*}
                    Karena limitnya adalah $\frac{1}{3}$, maka barisan tersebut konvergen dan nilai kekonvergenannya adalah $\frac{1}{3}$.
                }
            \end{jawab}
